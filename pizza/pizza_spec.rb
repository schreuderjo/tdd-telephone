...
describe 'Pizza' do
  let(:pizza) {Pizza.new("My pizza", "supreme")}
  let(:toppings) {pizza.toppings = [Topping.new("mushroom", 2),
  ...
  context "#initialize" do
    ...
    it 'has a name attribute of My pizza' do
      expect(pizza.name).to be("My pizza")
    end
    ...
    it 'has a description attribute of supreme' do
      expect(pizza.description).to be("supreme")
    end
...
describe 'Topping' do
  ...
  context "#initialize" do
    ...
    it 'has a name attribute of mushroom' do
      expect(topping.name).to be("mushroom")
    end
